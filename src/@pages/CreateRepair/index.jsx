        ...
        <div className="w-full flex flex-col justify-center">
          <form className="lg:px-6 lg:py-6 md:px-4 md:py-4 px-2 py-2">
            ...
            <div className="w-full flex justify-center items-center p-2.5 mt-6">
              <button className="w-full lg:text-lg md:text-base text-sm rounded-md bg-[#63C6B5] px-2 py-2 text-white border border-[#63C6B5] transition-all ease-in-out duration-500 hover:bg-white hover:text-[#63C6B5] cursor-pointer">
                {" "}
